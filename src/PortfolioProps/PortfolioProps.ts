...
export default function PortfolioProps(){
  ...
  const portfolioProps =[
    { id: 1,
      ...
      imgc:"../../public/assets/cardImg/Card1.png",
    },
    { id: 2,
      titlec: 'Achahada',
      textc: 'created with React, Nodejs and MongoDB',
      iconc: ArrowSquareOut,
      imgc:"../../public/assets/cardImg/Card2.png",
    }
    ,
    { id: 3,
      titlec: 'House rental',
      textc: 'created with React, Nodejs and MongoDB',
      iconc:ArrowSquareOut,
      imgc:"../../public/assets/cardImg/Card3.png",
    }, 
    { id: 4,
      titlec: 'Series & Movies',
      textc: 'created with Vite, Html and Css,  ',
      iconc:ArrowSquareOut,
      imgc:"../../public/assets/cardImg/Card4.png",
    },
    { id: 5,
      titlec: 'Crud',
      textc: 'created with Angular, SpringBoot and Mysql',
      iconc:ArrowSquareOut,
      imgc:"../../public/assets/cardImg/Card5.png",
    }
    ,
    { id: 6,
      titlec: 'RestAPI & DTO',
      ...
      iconc:ArrowSquareOut,
      imgc:"../../public/assets/cardImg/Card6.png",
    }
    ,
    { id: 7,
      titlec: 'RestAPI & DTO',
